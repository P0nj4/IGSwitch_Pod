...
//  Pods
//
//  Created by German Pereyra on 8/22/17.
//
//
...
@IBDesignable
public class IGSwitch: UIControl {
    ...
    @IBInspectable public var titleLeft: String! {
        didSet {
    ...
    @IBInspectable public var titleRight: String! {
        didSet {
